...
static const struct video_device em8300_video_template = {
	...
	//.ioctl_ops					= &video_ioctl_ops,  TODO
...
int em8300_video_setup(struct em8300_s *em)
{
	...
	write_register(I2C_PIN, 0x3c3c);
	write_register(I2C_OE, 0x3c00);
	write_register(I2C_OE, 0x3c3c);
	...
	write_register(INTERRUPT_ACK, 0x2);
	...
	em8300_ioctl_setvideomode(em, V4L2_STD_PAL);
